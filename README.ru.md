...
Скачай **`.dmg`** из [последнего релиза](https://github.com/mc-c0rp/mw/releases/latest) (например, `mw-1.0.0.dmg`), открой и перетащи **mw.app** в **Applications**. При первом запуске модель распознавания скачается автоматически.
